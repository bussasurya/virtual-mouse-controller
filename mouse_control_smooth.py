...
# Initialize smoothing variables for EMA
smoothing_factor = 0.4  # Adjust between 0.1 (smoother) and 0.9 (more responsive)
prev_screen_x, prev_screen_y = pyautogui.position()  # Start at current cursor position
